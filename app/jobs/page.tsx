...
export default function JobsPage() {
    return (
        <div className="flex-1 min-h-screen bg-white">
            <div className={`mb-6 relative ${montserrat.variable} ${merriweather.variable} font-sans`}>
      ...
      <JobListingContent />
            ...
            <div className="flex flex-col gap-y-2 lg:-mb-2">
                <div className="lg:flex hidden max-w-[90%] w-full border-b-2 border-gray-200 mx-auto py-8 hover:bg-gray-50 transition-all rounded-lg rounded-b-none">
                    <div className="w-[30%] px-3 font-semibold text-lg text-gray-900">Position</div>
                    <div className="w-[20%] px-3 font-semibold text-lg text-gray-900">Company</div>
                    <div className="w-[20%] px-3 font-semibold text-lg text-gray-900">Department</div>
                    <div className="w-[20%] px-3 font-semibold text-lg text-gray-900">Location</div>
