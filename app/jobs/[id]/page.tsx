...
export default async  function SpecificJobPage({
    ...
    return (
        <div className="min-h-screen bg-black flex flex-col">
            <div className="bg-zinc-900 px-8 py-10 pb-16 flex flex-col gap-y-8">
            ...
            <div className="flex flex-col md:flex-row p-4">
                <div className="px-6 md:w-[300px] flex gap-x-4 flex-wrap md:flex-col gap-y-3">
                    ...
                    <span className="text-white font-semibold text-base">Department</span>
                        <span className="text-gray-400 font-semibold text-sm">{job.department}</span>
                    </div>
                    <div  className="flex flex-col">
                    <span className="text-white font-semibold text-base">Location</span>
                        <span className="text-gray-400 font-semibold text-sm">{job.location}</span>
                    </div>
                    <div className="flex flex-col">
                    <span className="text-white font-semibold text-base">Company</span>
                        <span className="text-gray-400 font-semibold text-sm">{job.company}</span>
                    </div>
                    <div className="flex flex-col">
                    <span className="text-white font-semibold text-base">Requisition Id</span>
                        <span className="text-gray-400 font-semibold text-sm">{job.requisitionId}</span>
                        </div>
                </div>
