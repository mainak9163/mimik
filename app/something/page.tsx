...
export default function DoSomething({bgColor,imgSrc,onClick}:DoSomethingProps) {
  return (
    <button onClick={onClick}
      className={`relative bg-${bgColor}-700 w-[104px] h-[84px] hover:scale-105 transition-all duration-500 cursor-pointer [clip-path:polygon(20%_0,_100%_0,_100%_100%,_0_100%,_0_27.1%)] rounded-b-lg rounded-tr-lg border border-white/10 overflow-hidden group`}>
      <style>
        {
          `
