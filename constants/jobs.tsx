      ...
      <div className="job-description text-gray-200 text-lg mb-10">
        ...
        <div className="bg-gray-800 p-4 rounded-lg mt-6">
          <p className="italic text-gray-300">
            Pre-seed stage opportunity with potential for stock options as we secure funding. 
      ...
      <div className="job-description text-gray-200 text-lg mb-10">
        ...
        <div className="bg-gray-800 p-4 rounded-lg mt-6">
          <p className="italic text-gray-300">
            ...
            and stock options as we secure funding. Clear role with meaningful trajectory.
          </p>
        </div>
      </div>
    )
      ...
      <div className="job-description text-gray-200 text-lg mb-10">
        ...
        <div className="bg-gray-800 p-4 rounded-lg mt-6">
          <p className="italic text-gray-300">
            ...
            Be part of the team creating the next generation of emotionally intelligent game characters!
          </p>
        </div>
      </div>
    )
  },
  {
    ...
    description: (
      <div className="job-description text-gray-200 text-lg mb-10">
        ...
        <div className="bg-gray-800 p-4 rounded-lg mt-6">
          <p className="italic text-gray-300">
            Key technical role with competitive compensation and significant equity opportunities.
            Pioneer new approaches to agentic NPCs in a commercial game environment.
          </p>
        </div>
      </div>
    )
