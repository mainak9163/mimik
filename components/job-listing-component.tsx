      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="font-merriweather text-lg text-gray-700 space-y-4">
            <p>
              We&apos;re P3CO, an indie studio crafting{" "}
              <span className="font-semibold text-black">Astrapuffs</span> — a
              whimsical, AI-powered cozy sim where emotionally intelligent NPCs
              form real relationships with players. This isn&apos;t just another
              cute game — it&apos;s a shot at reimagining what NPCs can be.
            </p>
            <p>
              We&apos;re at the pre-seed stage and actively raising funds. In
              the meantime, we&apos;re opening the door for skilled
              professionals — artists, engineers, designers — who believe in the
              potential of agentic AI, cozy storytelling, and psychological
              safety in games.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="font-merriweather text-lg text-gray-700 space-y-4">
            <p>
              ...
              This is an <b>unpaid</b>, short-term opportunity with a path
              toward becoming part of our core team and earning stock options.
              You&apos;ll be building something ambitious with a clear,
              meaningful role and trajectory.
            </p>
          </div>
        </section>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-merriweather text-gray-700">
                    A working demo with functional agentic NPCs
                  </p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 border-l-4 border-black shadow-md">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="font-merriweather text-gray-700">
                    A defined product vision and global market fit
                  </p>
                </div>
              </div>
            </Card>
        ...
        <section className="bg-gray-50 p-8 rounded-lg border border-gray-200">
          ...
          <p className="font-merriweather text-lg text-gray-700">
            If you&apos;re between gigs, want to keep your skills sharp, or are
            ready to help shape a game that could truly shake the industry —
            let&apos;s talk.
          </p>
        </section>
      </div>
